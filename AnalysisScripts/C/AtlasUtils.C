...
void MY_LABEL(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  //  l.SetTextFont(60); // fett und gerade
  l.SetTextFont(42); // duenn und gerade
  l.SetTextColor(color);
  // l.DrawLatex(x,y,"Data/MC Ratio");
  l.DrawLatex(x,y,"has vertex");
}
...
void ATLAS_Pre(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
...
void ATLAS_MC(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
  l.SetTextColor(color);
  l.DrawLatex(x,y,"Pythia MC");
}

void ATLAS_Data(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
  l.SetTextColor(color);
  l.DrawLatex(x,y,"#sqrt{s} = 900 GeV");
}

void ATLAS_Data7TeV(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(42);
  l.SetTextColor(color);
  l.DrawLatex(x,y,"Data #sqrt{s} = 7 TeV");
}

void ATLAS_7TeV(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(42);
...
void ATLAS_myData(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(42);
  l.SetTextColor(color);
  l.DrawLatex(x,y,"Data 2010 at \#sqrt{s} = 7 TeV");
}

void ATLAS_phasespace_mb2(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l;// l.SetTextAlign(12); //l.SetTextSize(0.2); 
  l.SetNDC();
  l.SetTextFont(42);
  l.SetTextColor(12);
  l.DrawLatex(x,y,"p_{T} > 100 MeV, |#eta| < 2.5, n_{sel}^{BS} #geq 2");
  //l.DrawLatex(x,y,"p_{T} > 500 MeV, |#eta| < 2.5, n_{sel}^{BS} #geq 1");
}

void ATLAS_phasespace_mb1(Double_t x,Double_t y,Color_t color=1) 
{
  TLatex l;// l.SetTextAlign(12); //l.SetTextSize(0.2); 
  l.SetNDC();
  l.SetTextFont(42);
...
void myBoxText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,char *text, bool tline=1) {
...
void myLineText(Double_t x, Double_t y,Int_t boxsize,Int_t mcolor,char *text) {
