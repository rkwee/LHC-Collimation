...
def cv90():
    ...
    fDenom = thispath + 'results_pressure2012_ir1_BG_bs_4TeV_20MeV_b1_nprim5925000_67.root' 
    fNum = thispath + 'results_pressure2012_ir1_BG_bs_4TeV_20MeV_b1_nprim5925000_67.root' 
...
#     yrel = "/TCT hit"
    ...
    for skey in sDict.keys():
        ...
        cv = TCanvas( 'cv'+skey, 'cv'+skey, 1400, 900)
        x1, y1, x2, y2 = 0.52,0.75,0.9,0.9 # right corner
        ...
        lab = mylabel(42)
        lab.DrawLatex(0.41, 0.955, titleName )

        if goLeft: xpos+=0.3
        lab.DrawLatex(xpos-0.02, 0.85, sDict[skey][6] )
