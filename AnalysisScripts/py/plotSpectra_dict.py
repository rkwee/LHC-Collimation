...
hDict_HL_comp = {
    ...
    'EkinMuComp' : [['EkinMuBGst', 'EkinMuBGac', 'EkinMuBHds', 'EkinMuBHop' ],0.63,0.7,0.95,0.9, 1,1, 2e-2,9e3,1e-1,8e9, 0, '#mu^{#pm}', 0.55,0.85],
    'EkinPrComp' : [['EkinPrBGst', 'EkinPrBGac', 'EkinPrBHds', 'EkinPrBHop' ],0.63,0.7,0.95,0.9, 1,1, 2e-2,9e3,1e-1,8e9, 0, 'p', 0.55,0.85],
    'EkinPhComp' : [['EkinPhBGst', 'EkinPhBGac', 'EkinPhBHds', 'EkinPhBHop' ],0.63,0.7,0.95,0.9, 1,1, 2e-2,9e3,1e-1,8e9, 0, '#gamma', 0.55,0.85],
    'EkinEpComp' : [['EkinEpBGst', 'EkinEpBGac', 'EkinEpBHds', 'EkinEpBHop' ],0.63,0.7,0.95,0.9, 1,1, 2e-2,9e3,1e-1,8e9, 0, 'e^{#pm}', 0.55,0.85],
    'EkinNeComp' : [['EkinNeBGst', 'EkinNeBGac', 'EkinNeBHds', 'EkinNeBHop' ],0.63,0.7,0.95,0.9, 1,1, 2e-2,9e3,1e-1,8e9, 0, 'n', 0.55,0.85],
    'EkinChComp' : [['EkinChBGst', 'EkinChBGac', 'EkinChBHds', 'EkinChBHop' ],0.63,0.7,0.95,0.9, 1,1, 2e-2,9e3,1e-1,8e9, 0, '#pi^{#pm}, K^{#pm}', 0.55,0.85],

    'RadNMuComp' : [['RadNMuBGst', 'RadNMuBGac', 'RadNMuBHds', 'RadNMuBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, '#mu^{#pm}', 0.55,0.85],
    'RadNPrComp' : [['RadNPrBGst', 'RadNPrBGac', 'RadNPrBHds', 'RadNPrBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, 'p', 0.55,0.85],
    'RadNPhComp' : [['RadNPhBGst', 'RadNPhBGac', 'RadNPhBHds', 'RadNPhBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, '#gamma', 0.55,0.85],
    'RadNEpComp' : [['RadNEpBGst', 'RadNEpBGac', 'RadNEpBHds', 'RadNEpBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, 'e^{#pm}', 0.55,0.85],
    'RadNNeComp' : [['RadNNeBGst', 'RadNNeBGac', 'RadNNeBHds', 'RadNNeBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, 'n', 0.55,0.85],
    'RadNChComp' : [['RadNChBGst', 'RadNChBGac', 'RadNChBHds', 'RadNChBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, '#pi^{#pm}, K^{#pm}', 0.55,0.85],

    'RadEnMuComp' : [['RadEnMuBGst', 'RadEnMuBGac', 'RadEnMuBHds', 'RadEnMuBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, '#mu^{#pm}', 0.55,0.85],
    'RadEnPrComp' : [['RadEnPrBGst', 'RadEnPrBGac', 'RadEnPrBHds', 'RadEnPrBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, 'p', 0.55,0.85],
    'RadEnPhComp' : [['RadEnPhBGst', 'RadEnPhBGac', 'RadEnPhBHds', 'RadEnPhBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, '#gamma', 0.55,0.85],
    'RadEnEpComp' : [['RadEnEpBGst', 'RadEnEpBGac', 'RadEnEpBHds', 'RadEnEpBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, 'e^{#pm}', 0.55,0.85],
    'RadEnNeComp' : [['RadEnNeBGst', 'RadEnNeBGac', 'RadEnNeBHds', 'RadEnNeBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, 'n', 0.55,0.85],
    'RadEnChComp' : [['RadEnChBGst', 'RadEnChBGac', 'RadEnChBHds', 'RadEnChBHop' ],0.63,0.7,0.95,0.9, 0,1, 0,600.,-1,-1, 0, '#pi^{#pm}, K^{#pm}', 0.55,0.85],
...
hDict_HL_BH = { 
    ...
    'EkinChar' + tag_HL : [[ 'EkinPos','EkinNeg','EkinNeu', 'EkinPiPlus','EkinPiMinus','EkinPiZero','EkinPhotons'],0.52, 0.7, 0.98, 0.9, 1,1, 2e-2,1e4,1e-6,9, 0, lText, 0.2,0.9, ],
...
hDict_HL_BGac = { # hkey = pname; #0 list of hists #1 legend x1 #2 y1 #3 x2 #4 y2 #5 doLogx #6 doLogy #7 XurMin #8 XurMax #9 YurMin #10 YurMax #11 doFill #12 lText #13 lx #14 ly
    ...
    'EkinChar' + tag_HL : [[ 'EkinPos','EkinNeg','EkinNeu', 'EkinPiPlus','EkinPiMinus','EkinPiZero','EkinPhotons'],0.6,0.7,0.98,0.9, 1,1, 2e-2,1e4,2e2,1e8, 0, lText, 0.7,0.9, ],
