...
def cv34():
    ...
    # fluka
    rfFname = "anton.FL_TCT5IN_roundthin_anton.run_00000.dat.root"
    
    # sixtrack
    rfSname = "tct5inrd.root"


    rfFname = "anton.FL_ats-HL_LHC_nominal.run_00000.hllhc_ir1_tightsett_b2001_fort.83.root"
    rfSname = "TCTIMPAC.root"
    ...
    for pV in hDict.keys():
        ...
        if not var.count(':'):
            ...
            hnameS = prettyVar + "_TCTH4_sixtrack"
        ...
        pname = wwwpath
        #pname += 'TCT/HL/relaxedColl/newScatt/fluka/geo/compFlukaSixTrack_' + hname + '.png'
        pname += 'TCT/HL/nominalColl/compFlukaSixTrack_' + hname + '.png'
