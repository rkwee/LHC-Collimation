...
def generate_sDict( tag, norm, tBBG, yrel ):
 ...
 'RadNAll'+tag:[ ['all'],norm, 1200, 0, 1200, tBBG, 'all', kBlack, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNMuons'+tag:[ ['10', '11'], norm, 1200, 0, 1200, tBBG, '#mu^{#pm} ', kAzure, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNNeutrons'+tag:[ ['8'], norm, 1200, 0, 1200, tBBG, 'neutrons',kRed, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNProtons'+tag:[ ['1'], norm, 1200, 0, 1200, tBBG, 'protons', kCyan, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNPhotons'+tag:[ ['7'], norm, 1200, 0, 1200, tBBG, '#gamma', kOrange+1, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNElecPosi'+tag:[ ['3','4'], norm, 1200, 0, 1200, tBBG, 'e^{#pm}', kOrange-2, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNPions'+tag:[ ['13','14'], norm, 1200, 0, 1200, tBBG, '#pi^{#pm}',kPink+1, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNKaons'+tag:[ ['15','16','24'], norm, 1200, 0, 1200, tBBG, 'K^{#pm,0}', kSpring-1, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],

 'RadNMuonsEAll'+tag:[ ['10', '11'], norm, 1200, 0, 1200, tBBG, '#mu^{#pm}', kRed-10, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNMuonsE20'+tag:[ ['10', '11'], norm, 1200, 0, 1200, tBBG, '#mu^{#pm} with E_{kin} > 20 GeV', kRed-7,'20.','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNMuonsE100'+tag:[ ['10', '11'], norm, 1200, 0, 1200, tBBG, '#mu^{#pm} with E_{kin} > 100 GeV', kRed-6,'100.','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNMuonsE500'+tag:[ ['10', '11'], norm, 1200, 0, 1200, tBBG, '#mu^{#pm} with E_{kin} > 500 GeV', kRed-1,'500.','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNMuonsE1000'+tag:[ ['10', '11'], norm, 1200, 0, 1200, tBBG, '#mu^{#pm} with E_{kin} > 1 TeV', kRed-1,'1000.','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 
 'RadNNeg'+ tag:[ ['11','3','14','16'], norm, 1200, 0, 1200, tBBG, 'K^{-}, e^{-},#mu^{-},#pi^{-}', kMagenta+1, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNPos'+ tag:[ ['1','10','4','15','13'], norm, 1200, 0, 1200, tBBG, 'p,K^{+},e^{+},#mu^{+},#pi^{+}', kGreen+1, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadNNeu'+tag:[ ['7','24','8'], norm, 1200, 0, 1200, tBBG, 'n,K^{0},#gamma', kBlue, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],

 'RadEnAll'+tag:[ ['all'],norm, 1200, 0, 1200, tBBG, 'all', kBlack, '-9999','r [cm]', 'GeV/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadEnMuons'+tag:[ ['10', '11'], norm, 1200, 0, 1200, tBBG, '#mu^{#pm} ', kAzure, '-9999','r [cm]', 'GeV/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadEnNeutrons'+tag:[ ['8'], norm, 1200, 0, 1200, tBBG, 'neutrons',kRed, '-9999','r [cm]', 'GeV/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadEnProtons'+tag:[ ['1'], norm, 1200, 0, 1200, tBBG, 'protons', kCyan, '-9999','r [cm]', 'GeV/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadEnPhotons'+tag:[ ['7'], norm, 1200, 0, 1200, tBBG, '#gamma', kOrange+1, '-9999','r [cm]', 'GeV/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadEnElecPosi'+tag:[ ['3','4'], norm, 1200, 0, 1200, tBBG, 'e^{#pm}', kOrange-2, '-9999','r [cm]', 'GeV/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadEnPions'+tag:[ ['13','14'], norm, 1200, 0, 1200, tBBG, '#pi^{#pm}', kPink+1, '-9999','r [cm]', 'GeV/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadEnKaons'+tag:[ ['15','16','24'], norm, 1200, 0, 1200, tBBG, 'K^{#pm,0}', kSpring-1, '-9999','r [cm]', 'GeV/cm^{2}'+yrel, -9999, -9999, -9999, ],
 
 'RadEnNeg'+tag:[ ['11','3','14','16'], norm, 1200, 0, 1200, tBBG, 'K^{-}, e^{-},#mu^{-},#pi^{-}', kMagenta+1, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 'RadEnPos'+tag:[ ['1','10','4','15','13'], norm, 1200, 0, 1200, tBBG, 'p,K^{+},e^{+},#mu^{+},#pi^{+}', kGreen+1, '-9999','r [cm]', 'particles/cm^{2}'+yrel, -9999, -9999, -9999, ],
 ...
 'PhiNMuonsZ2R2'+tag:[ ['10', '11'], norm, 100, -math.pi, math.pi, tBBG, '#mu^{#pm} 1m < r < 2m, 59m < z < 153m',kGreen-7, 'z > 5900. : z < 15300. : r < 200. :  r > 100.','#phi [rad]', 'particles/rad'+yrel, -9999, -9999, -9999, ],
 ...
 'PhiNMuonsZ1R1E100'+tag:[ ['10', '11'], norm, 100, -math.pi, math.pi, tBBG, '#mu^{#pm} E > 100GeV, r < 1m, 22.6m < z < 59m',kOrange-9, 'z > 2260. : z < 5900. : r < 100. : E > 100.','#phi [rad]', 'particles/rad'+yrel, -9999, -9999, -9999, ],
 'PhiNMuonsZ2R1E100'+tag:[ ['10', '11'], norm, 100, -math.pi, math.pi, tBBG, '#mu^{#pm} E > 100GeV, r < 1m, 59m < z < 153m',kRed-9, 'z > 5900. : z < 15300. : r < 100. : E > 100.','#phi [rad]', 'particles/rad'+yrel, -9999, -9999, -9999, ],
 'PhiNMuonsZ3R1E100'+tag:[ ['10', '11'], norm, 100, -math.pi, math.pi, tBBG, '#mu^{#pm} E > 100GeV, r < 1m, 153m < z < 269m',kPink-9, 'z > 15300. : z < 26900. : r < 100. : E > 100.','#phi [rad]', 'particles/rad'+yrel, -9999, -9999, -9999, ],
 'PhiNMuonsZ4R1E100'+tag:[ ['10', '11'], norm, 100, -math.pi, math.pi, tBBG, '#mu^{#pm} E > 100GeV, r < 1m, 269m < z < 547m',kMagenta-9, 'z > 26900. : r < 100.  : E > 100.','#phi [rad]', 'particles/rad'+yrel, -9999, -9999, -9999, ],

 'PhiEnMuonsZ1R1E100'+tag:[ ['10', '11'], norm, 100, -math.pi, math.pi, tBBG, '#mu^{#pm} E > 100GeV, r < 1m, 22.6m < z < 59m',kGreen-9, 'z > 2260. : z < 5900. : r < 100. : E > 100.','#phi [rad]', 'GeV/rad'+yrel, -9999, -9999, -9999, ],
 'PhiEnMuonsZ2R1E100'+tag:[ ['10', '11'], norm, 100, -math.pi, math.pi, tBBG, '#mu^{#pm} E > 100GeV, r < 1m, 59m < z < 153m',kBlue-9, 'z > 5900. : z < 15300. : r < 100. : E > 100.','#phi [rad]', 'GeV/rad'+yrel, -9999, -9999, -9999, ],
 ...
 'XYNProtonsE'+tag:[ ['1'], norm, 1200, -120, 120, tBBG, 'protons 10 GeV < E_{kin} < 150 GeV', kWhite, '10.:150.','x [cm]','y [cm]', 1200, -120, 120, ],
 'XYNPiPlusE'+tag:[ ['13'], norm, 1200, -120, 120, tBBG, '#pi^{+} 10 GeV < E_{kin} < 150 GeV',kWhite, '10.:150.','x [cm]','y [cm]', 1200, -120, 120, ],
 'XYNPiMinusE'+tag:[ ['14'], norm, 1200, -120, 120, tBBG, '#pi^{-} 10 GeV < E_{kin} < 150 GeV',kWhite, '10.:150.','x [cm]','y [cm]', 1200, -120, 120, ],
 'XYNKaonsE'+tag:[ ['15','16'], norm, 1200, -120, 120, tBBG, 'K^{#pm} 10 GeV < E_{kin} < 150 GeV',kWhite, '10.:150.','x [cm]','y [cm]', 1200, -120, 120, ],
