...
\end{center}
\vspace{-0.6cm}
 \caption{Gas densities up to the arc for the most common molecules (top) and split into atomic components to indicate the interaction probability (bottom). Also the data for the 4~TeV fill is shown but without constant extension out to the arc.
  \label{pressure2015}}
\end{figure}
...
\end{center}
\vspace{-0.6cm}
 \caption{Origin of muon production along s, in black before and in gold after re-normalising to the 2015 pressure profile. All particles, protons and photons are shown in the appendix in Fig.~\ref{fig:OrigZ6p52}. 
  \label{fig:OrigZ6p5}}
\end{figure}
...
\end{center}
\vspace{-0.6cm}
 \caption{Muon distributions before (black) and after (gold) reweightening with the pressure map. The same set of plots for all particles are in the appendix, in Fig.~\ref{fig:EkinPhiEn6p52}.
