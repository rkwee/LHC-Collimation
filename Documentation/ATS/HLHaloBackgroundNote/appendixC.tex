\section{Additional plots for Run~1, Run~2 and HL-LHC shower simulations\label{run1run2app}}
...
\includegraphics[width=0.49\textwidth]{figures/BH_run2/b2/OrigXYMuons_BH_6500GeV_haloB2_20MeV.pdf}
 \caption{Betatron halo induced background at the interface plane from B2 in Run~2 2015 simulations (6.5~TeV). 
...
\end{center}
\vspace{-0.6cm}
 \caption{Run~2 2015 at 6.5~TeV: Comparison of B1 and B2 betatron halo induced distributions per TCT hit for muons.
