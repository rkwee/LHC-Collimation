...
%
\author{R.~Kwee-Hinzmann, R.~Bruce, F.~Cerutti,~L.~S.~Esposito, S.~M.~Gibson, A.~Lechner, H.~G.~Morales}
%
\date{\today}
...
\makeindex
%
\documentlabel{CERN-ATS-Note-2015-XXX PERF}\keywords{halo background, beam-gas, SixTrack, FLUKA, HL-LHC, TCT5, collimation, cleaning efficiency}
%
