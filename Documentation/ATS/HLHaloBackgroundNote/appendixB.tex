\section{SixTrack TCP-to-TCT conversion factors}
\subsection*{IR7 to TCT conversion factors in betatron halo cleaning simulations\label{leakageFactorsIR7}}

SixTrack simulation results for 2012 Run~1, 2015~Run~2 and HL-LHC are shown in Tab.~\ref{tab:leakageFactorsIR7}, and for 2016 Run~2 in Tab.~\ref{2016leakageFactorsIR7}.
\begin{table}
   \centering
...
SixTrack simulation results for 2012 Run~1 and 2015~Run~2 are shown in Tab.~\ref{tab:IR3leakageFactors}.
\begin{table}[!h]
   \centering
